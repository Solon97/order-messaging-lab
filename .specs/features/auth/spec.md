...
| Posição no roadmap | Nova Fase 1 ("Autenticação — Cognito", sem autorização — ver Out of Scope acima); fase `messaging-flow` (SNS/SQS) vira Fase 2, `RabbitMQ` vira Fase 3 | Decisão explícita do usuário — reordenar ROADMAP.md | y |
